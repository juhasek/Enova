# WeryfikacjaAlokacjiZapis (cecha KartaCzasuPracy)
...
- **ID w bazie Claude:** `18`
- **GUID:** `F9394B13-E1DC-42B9-97C5-D19AF6D45811`
- **Zweryfikowano na żywo:** Nie — kod przeniesiony z bazy do repo po analizie
  i korektach na życzenie klienta, bez testu w GUI.

Niemal identyczny duplikat kodu z [[WeryfikacjaAlokacjiZmianaDnia]] (ID 17) —
